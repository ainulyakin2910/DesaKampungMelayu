...
<body class="hold-transition skin-red sidebar-mini fixed skin-red-light">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    ...
                    $b = $data->row_array();
                    ?>
                    <form action="<?php echo base_url() . 'admin/apbdes/update_apbdes' ?>" method="post" enctype="multipart/form-data">

                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <input type="text" name="xjudul" class="form-control" value="<?php echo $b['judul']; ?>" placeholder="Judul APBDES atau artikel" required />
                                </div>
                                <!-- /.col -->
                                <div class="col-md-2">
    ...
    <?php elseif ($this->session->flashdata('msg') == 'info1') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Info',
                text: "APBDES berhasil di update tdengan gambar tetap",
                showHideTransition: 'slide',
                icon: 'info',
                hideAfter: false,
                position: 'bottom-right',
