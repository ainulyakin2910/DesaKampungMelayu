						...
						<div class="box">
							...
							<div class="box">
								<div class="box-header">
									<a class="btn btn-success btn-flat" href="<?php echo base_url() . 'admin/berita/add_berita' ?>"><span
											class="fa fa-plus"></span> Post Berita</a>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
                          ...
                          ?>
											<tr>
												...
												<td style="text-align:right;">
													<a class="btn" href="<?php echo base_url() . 'admin/berita/get_edit/' . $id; ?>"><span
	...
	<div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo base_url() . 'admin/berita/hapus_berita' ?>" method="post"
