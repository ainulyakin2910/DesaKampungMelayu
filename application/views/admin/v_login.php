...
<head>
    <title>Login Kampung Melayu</title>
    <meta charset="UTF-8">
    <meta name="keyword" content="Website Desa Kampung Melayu">
    <meta name="description" content="Portal Resmi Desa Kampung Melayu">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title" style="background-image: url(<?php echo base_url() . 'assetss/images/desa.jpg' ?>);">
                    <span class="login100-form-title-1">
                        Login Admin Kampung Melayu
                    </span>
                </div>
